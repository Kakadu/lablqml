...
----
To count how many times we clicked we need additional variable available in an object. We will add it into `program.ml`:
...
TODO:
https://qt-project.org/doc/qt-5/qvariant.html[QVariant].

https://qt-project.org/doc/qt-5/qtqml-typesystem-basictypes.html[basic types].
