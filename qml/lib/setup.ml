...
(* OASIS_START *)
(* DO NOT EDIT (digest: 7e36637f5d0e9c1fc925e50df400e2d1) *)
(*
...
let setup_t =
  {
               ...
               Library
                 ({
                     ...
                     },
                   {
                      ...
                      bs_c_sources =
                        ["stubs.c"; "stubs.h"; "kamlo.h"; "modelindex.c"];
                      bs_data_files = [("stubs.h", None); ("kamlo.h", None)];
                      bs_ccopt =
                        [
     ...
     oasis_digest =
       Some "\197;\129f\138\026\251\028#\019\199\017\168\023\029\168";
     oasis_exec = None;
     oasis_setup_args = [];
     setup_update = false;
     };;
