...
(* OASIS_START *)
(* DO NOT EDIT (digest: 620211356ff4e5fa9f6aae34a54e6c04) *)
(*
...
(* # 21 "/home/kakadu/.opam/4.00.1/build/oasis.0.3.0/src/plugins/custom/CustomPlugin.ml" *)
...
let setup_t =
  {
     ...
     oasis_version = "0.3.0";
     oasis_digest = Some "*5.\222\248m7\188\239\011\015\172q\011\129J";
     oasis_exec = None;
     oasis_setup_args = [];
     setup_update = false;
     };;
