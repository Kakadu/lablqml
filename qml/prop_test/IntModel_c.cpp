#include "IntModel_c.h"

IntModel::IntModel() : _camlobjHolder(0) {
}
//parent: QModelIndex.t->QModelIndex.t
QModelIndex IntModel::parent(const QModelIndex & x0) const {
  CAMLparam0();
...
QModelIndex IntModel::index(int x0,int x1,const QModelIndex & x2) const {
  CAMLparam0();
  CAMLlocal3(_ans,_meth,_x0);
  CAMLlocalN(_args,4);
...
int IntModel::columnCount(const QModelIndex & x0) const {
  CAMLparam0();
  CAMLlocal3(_ans,_meth,_x0);
  CAMLlocalN(_args,2);
  CAMLlocal1(_cca0);
...
int IntModel::rowCount(const QModelIndex & x0) const {
  CAMLparam0();
  CAMLlocal3(_ans,_meth,_x0);
  CAMLlocalN(_args,2);
  CAMLlocal1(_cca0);
...
bool IntModel::hasChildren(const QModelIndex & x0) const {
  CAMLparam0();
  CAMLlocal3(_ans,_meth,_x0);
  CAMLlocalN(_args,2);
  CAMLlocal1(_cca0);
...
QVariant IntModel::data(const QModelIndex & x0,int x1) const {
  CAMLparam0();
  CAMLlocal3(_ans,_meth,_x0);
  CAMLlocalN(_args,3);
