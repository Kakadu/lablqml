...
(* OASIS_START *)
(* DO NOT EDIT (digest: 70b6064de81afb18a3c3e21b7767f800) *)
(*
...
let setup_t =
  {
     ...
     package =
       {
          ...
          authors = ["Kakadu"];
          homepage = None;
          synopsis = "Codegeneration tool for lablqt";
          description = None;
          categories = [];
            ...
            [
               ...
               Executable
                 ({
                   ...
                   {exec_custom = false; exec_main_is = "ppx_qt.ml"})
            ];
     ...
     oasis_version = "0.4.4";
     oasis_digest = Some "\209\249_\161\128a5\223\161\004\183\178\235e\190l";
     oasis_exec = None;
     oasis_setup_args = [];
     setup_update = false
  };;
