#include "MainModel_c.h"

MainModel::MainModel() : _camlobjHolder(0) {
}
//parent: QModelIndex.t->QModelIndex.t
QModelIndex MainModel::parent(const QModelIndex & x0) const {
  CAMLparam0();
...
QModelIndex MainModel::index(int x0,int x1,const QModelIndex & x2) const {
  CAMLparam0();
  CAMLlocal3(_ans,_meth,_x0);
  CAMLlocalN(_args,4);
...
int MainModel::columnCount(const QModelIndex & x0) const {
  CAMLparam0();
  CAMLlocal3(_ans,_meth,_x0);
  CAMLlocalN(_args,2);
  CAMLlocal1(_cca0);
...
int MainModel::rowCount(const QModelIndex & x0) const {
  CAMLparam0();
  CAMLlocal3(_ans,_meth,_x0);
  CAMLlocalN(_args,2);
  CAMLlocal1(_cca0);
...
bool MainModel::hasChildren(const QModelIndex & x0) const {
  CAMLparam0();
  CAMLlocal3(_ans,_meth,_x0);
  CAMLlocalN(_args,2);
  CAMLlocal1(_cca0);
...
QVariant MainModel::data(const QModelIndex & x0,int x1) const {
  CAMLparam0();
  CAMLlocal3(_ans,_meth,_x0);
  CAMLlocalN(_args,3);
...
extern "C" value caml_MainModel_dataChanged_cppmeth_wrapper(value _cppobj,value _x0,value _x1) {
  CAMLparam3(_cppobj,_x0,_x1);
  CAMLlocal1(_z0);
  MainModel *o = (MainModel*) (Field(_cppobj,0));
  QModelIndex z0;
...
extern "C" value caml_MainModel_beginInsertRows_cppmeth_wrapper(value _cppobj,value _x0,value _x1,value _x2) {
...
extern "C" value caml_MainModel_endInsertRows_cppmeth_wrapper(value _cppobj,value _x0) {
...
extern "C" value caml_MainModel_beginRemoveRows_cppmeth_wrapper(value _cppobj,value _x0,value _x1,value _x2) {
  CAMLparam4(_cppobj,_x0,_x1,_x2);
  CAMLlocal1(_z0);
  MainModel *o = (MainModel*) (Field(_cppobj,0));
  QModelIndex z0;
...
extern "C" value caml_MainModel_endRemoveRows_cppmeth_wrapper(value _cppobj,value _x0) {
  CAMLparam2(_cppobj,_x0);
  CAMLlocal1(_z0);
  MainModel *o = (MainModel*) (Field(_cppobj,0));
  o->endRemoveRows();
...
extern "C" value caml_MainModel_addRole_cppmeth_wrapper(value _cppobj,value _x0,value _x1) {
  CAMLparam3(_cppobj,_x0,_x1);
  CAMLlocal1(_z0);
  MainModel *o = (MainModel*) (Field(_cppobj,0));
  int z0;
...
extern "C" value caml_create_MainModel(value _dummyUnitVal) {
  CAMLparam1(_dummyUnitVal);
  CAMLlocal1(_ans);
  _ans = caml_alloc_small(1, Abstract_tag);
  (*((MainModel **) &Field(_ans, 0))) = new MainModel();
  CAMLreturn(_ans);
}
extern "C" value caml_store_value_in_MainModel(value _cppobj,value _camlobj) {
