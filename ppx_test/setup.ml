...
(* OASIS_START *)
(* DO NOT EDIT (digest: 8e408f742ffc61b1bd2a2743bc4df478) *)
(*
...
let setup_t =
  {
     ...
     package =
       {
          ...
          homepage = None;
          synopsis =
            "A -ppx extension to replace [%getenv \"<var>\"] with compile-time value";
          description = None;
          categories = [];
            ...
            [
               Executable
                 ({
                   ...
                   {exec_custom = false; exec_main_is = "ppx_getenv.ml"});
               Executable
                 ({
                     cs_name = "ppx_qt";
                     cs_data = PropList.Data.create ();
     ...
     oasis_version = "0.4.4";
     oasis_digest = Some "w\166F\030p\175\191\186\183\134[M^\136\244\232";
     oasis_exec = None;
     oasis_setup_args = [];
     setup_update = false
  };;
